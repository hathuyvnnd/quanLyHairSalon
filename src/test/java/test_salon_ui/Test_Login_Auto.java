...
public class Test_Login_Auto {
    ...
    public void openMainFrame() {
        try {
            ...
            java.util.logging.Logger.getLogger(Test_Login_Auto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public void testAdminLogin() {
        try {
            ((Object) dangNhapJDialog).getTxtMaNV().setText("tuanhm");
            ...
            TestNGResult.put("2", new Object[] { 1d, "Đăng nhập thành công với tài khoản admin", "Đăng nhập thành công tài khoản không phải Admin", "Fail" });
